...
description: Evaluates code against Apple's App Store Review Guidelines. Use this skill when reviewing iOS, macOS, tvOS, watchOS, or visionOS app code (Swift, Objective-C, React Native, Expo, or Flutter) to identify potential App Store rejection issues before submission. Triggers on tasks involving app review preparation, compliance checking, or App Store submission readiness.
license: MIT
metadata:
  author: safaiyeh
  version: "1.1.1"
...
**Supports:** Swift, Objective-C, React Native, Expo, and Flutter apps (see [6-flutter.md](6-flutter.md) for Flutter/Buyselles paths)
