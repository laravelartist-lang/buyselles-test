...
class ClearanceProductFilterDialog extends StatefulWidget {
  ...
  const ClearanceProductFilterDialog({super.key, this.slug,  this.fromShop = true, this.authorList, this.publishingHouse, required this.applyFilter});
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column( crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                              children: [
                                ...
                                //Author
                                if(_authorList != null && _authorList!.isNotEmpty && (searchProvider.productTypeIndex == 0 || searchProvider.productTypeIndex == 2))...[
                                  const SizedBox(height: Dimensions.paddingSizeSmall),
                                            ...
                                            itemBuilder: (context, index){
                                              return Column(children: [
                                                CategoryFilterItem(title: _authorList![index].name,
                                                  ...
                                                  count: _authorList![index].productsCount,
                                                  onTap: () {
                                            ...
                                            itemBuilder: (context, index){
                                              return Column(children: [
                                                CategoryFilterItem(title: _publishingHouse![index].name,
                                                    ...
                                                    count: _publishingHouse![index].productsCount,
