...
class CustomCheckBoxWidget extends StatelessWidget {
  ...
  const CustomCheckBoxWidget({super.key,  required this.index, this.isDigital =  false, this.icon, required this.name, required this.title, this.padding, this.onSelected});
