...
class Shop {
  ...
  Shop.fromJson(Map<String, dynamic> json, {bool isAdminProduct = false}) {
    ...
    if(isAdminProduct) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        vacationEndDate = inHouseVacationAdd?.vacationEndDate;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['vacation_start_date'] = vacationStartDate?.toIso8601String();
    data['vacation_end_date'] = vacationEndDate?.toIso8601String();
    ...
    if (vacationDurationType != null) {
      data['vacation_duration_type'] = vacationDurationType!.toJson();
    }
    return data;
  }
}
