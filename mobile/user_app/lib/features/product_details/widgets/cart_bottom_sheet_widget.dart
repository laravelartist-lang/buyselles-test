                          ...
                          Expanded(child: Column(
                            ...
                            children: [
                              ...
                              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                (widget.product?.discount != null && (widget.product?.discount ?? 0) > 0) || (widget.product?.clearanceSale?.discountAmount ?? 0) > 0 ?
                                CustomDirectionalityWidget(
                                  child: Text('${PriceConverter.convertPrice(context, startingPrice! * (productDetailsController.quantity ?? 1))}'
                                    '${endingPrice!= null ? ' - ${PriceConverter.convertPrice(context, endingPrice * (productDetailsController.quantity ?? 1))}' : ''}',
                                    style: titilliumRegular.copyWith(color: Theme.of(context).hintColor,
                                      decoration: TextDecoration.lineThrough,
                                ...
                                CustomDirectionalityWidget(
                                  child: Text('${startingPrice != null ? PriceConverter.convertPrice(
                                    context, startingPrice * (productDetailsController.quantity ?? 1),
                                    discount: (widget.product?.clearanceSale?.discountAmount ?? 0) > 0
                                      ? widget.product?.clearanceSale?.discountAmount
                                      : widget.product?.discount,
                                    discountType: (widget.product?.clearanceSale?.discountAmount ?? 0) > 0
                                    ...
                                    context, endingPrice * (productDetailsController.quantity ?? 1),
                                    discount: (widget.product?.clearanceSale?.discountAmount ?? 0) > 0
                                      ? widget.product?.clearanceSale?.discountAmount
                                      : widget.product?.discount,
                                    discountType: (widget.product?.clearanceSale?.discountAmount ?? 0) > 0 
                                          ...
                                          child: Container(
                                            ...
                                            child: Center(
                                              child: Text(extensions[index][i].trim(), maxLines: 1,
                                                  overflow: TextOverflow.ellipsis, style: titilliumSemiBold.copyWith(
                                                    fontSize: Dimensions.fontSizeDefault,
                ...
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    QuantityButton(
                      ...
                      hasSupplierMapping: widget.product!.hasActiveSupplierMapping,
                    ),

                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                      child: Text(productDetailsController.quantity.toString(), style: textMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color)),
                    ),
                ...
                Padding(
                  ...
                  child: CustomButton(
                    ...
                    onTap: () {
                      ...
                      showCustomSnackBarWidget(getTranslated('to_request_the_restock', context), context, snackBarType: SnackBarType.warning);
                    },
                  ),
                ) :
                  ...
                  child: Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.homePagePadding,
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      ...
                      Expanded(child: Consumer<SplashController>(builder: (context, configProvider,_) {
                        return CustomButton(
                          isBuy:true, radius: 6,
                          buttonText: getTranslated(stock == 0  && widget.product!.productType == "physical" && (widget.product!.hasActiveSupplierMapping ?? 0) != 1 ? 'out_of_stock' : 'buy_now', context),
                          onTap:() async {
...
class QuantityButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        splashColor: Theme.of(context).hintColor.withValues(alpha: 0.3),
        highlightColor: Theme.of(context).hintColor.withValues(alpha: 0.1),
        borderRadius: BorderRadius.circular(50),
        onTap: () {
          if (!isIncrement && quantity! > 1 ) {
            if(quantity! > minimumOrderQuantity! ) {
              ...
              showCustomSnackBarWidget(getTranslated('minimum_quantity_is', context), context, snackBarType: SnackBarType.warning);
            }
          } else if(isIncrement && quantity! >= stock! && !digitalProduct && (hasSupplierMapping ?? 0) != 1) {
            showCustomSnackBarWidget(getTranslated('out_of_stock', context), context, snackBarType: SnackBarType.warning);
          } else if (isIncrement && quantity! < stock! || digitalProduct || (hasSupplierMapping ?? 0) == 1) {
            Provider.of<ProductDetailsController>(context, listen: false).setQuantity(quantity! + 1);
          }
        ...
        child: Container(width: 40,height: 40,
          decoration: BoxDecoration(
            ...
            Theme.of(context).disabledColor : (!isIncrement && quantity ==1 ) ?
