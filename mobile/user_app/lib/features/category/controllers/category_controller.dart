...
import 'package:flutter_sixvalley_ecommerce/features/category/helpers/seller_category_filter_helper.dart';
...
class CategoryController extends ChangeNotifier {
  ...
  Future<void> getSellerWiseCategoryList(String slug) async {
      ...
      if (apiResponse.response != null && apiResponse.response!.statusCode == 200) {
        ...
        final filteredData = SellerCategoryFilterHelper.filterCategoryData(
          List<dynamic>.from(apiResponse.response!.data),
        );
        for (final category in filteredData) {
