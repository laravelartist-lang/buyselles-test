...
class ConfigModel {
  ...
  ImageFullUrl? allProductsTabImage;
  ...
  ConfigModel.fromJson(Map<String, dynamic> json) {
    ...
    companyFavIcon = json['company_fav_icon'] != null
      ...
      : null;
    allProductsTabImage = json['all_products_tab_image'] != null
      ? ImageFullUrl.fromJson(json['all_products_tab_image'])
      : null;
    ...
    productMaxUnitPriceRange = double.tryParse(json['product_max_unit_price_range'].toString()) ;
    productMinUnitPriceRange = double.tryParse(json['product_min_unit_price_range'].toString());
    ...
    customerServiceFeeStatus = int.tryParse(json['customer_service_fee_status'].toString());
    customerServiceFee = double.tryParse(json['customer_service_fee'].toString());
    customerServiceFeeType = json['customer_service_fee_type']?.toString();
    googleClientId = json['google_client_id']?.toString() ?? customerLogin?.googleClientId;
  }
...
class CustomerLogin {
  ...
  CustomerLogin({this.loginOption, this.socialMediaLoginOptions, this.googleClientId});
