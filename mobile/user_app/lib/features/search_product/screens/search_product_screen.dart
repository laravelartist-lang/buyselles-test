...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    ...
    if (searchProvider.fromHomeFilter) {
      searchProvider.fromHomeFilter = false;
    } else {
      searchProvider.cleanSearchProduct();
      searchProvider.initHistoryList();
      searchProvider.setInitialFilerData();

      Provider.of<CategoryController>(context, listen: false).resetChecked(null, false);
      searchProvider.setFilterApply(isFiltered: false, isSorted: false, isUpdate: false);
          ...
          SliverToBoxAdapter(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Consumer<SearchProductController>(
              builder: (context, searchProvider, child) {
                ...
                const SearchProductWidget() : const NoInternetOrDataScreenWidget(isNoInternet: false, icon: Images.noProduct, message: 'no_product_found') :
