...
class SearchProductRepository implements SearchProductRepositoryInterface{
  ...
  @override
  Future<ApiResponseModel> getSearchProductList(String query, String? categoryIds, String? brandIds, String? authorIds, String? publishingIds, String? sort, String? priceMin, String? priceMax, int offset, String? productType, {int? countryId, int? cityId, int? areaId}) async {
