...
class _ProfileScreen1State extends State<ProfileScreen1> {
  ...
  Future<void> _updateUserAccount() async {
    ...
    if (Provider.of<ProfileController>(context, listen: false)
      ...
      showCustomSnackBarWidget(
          getTranslated('first_name_is_required', context), context,
          snackBarType: SnackBarType.warning);
      ...
      final profileController =
          Provider.of<ProfileController>(context, listen: false);
      final currentUser = profileController.userInfoModel!;
      final bool emailChanged = currentUser.email != email;
      final bool phoneChanged = currentUser.phone != phoneNumber;

      final ProfileModel updateUserInfoModel = ProfileModel(
        id: currentUser.id,
        ...
        imageFullUrl: currentUser.imageFullUrl,
        email: email,
        emailVerifiedAt: emailChanged ? null : currentUser.emailVerifiedAt,
        createdAt: currentUser.createdAt,
        updatedAt: currentUser.updatedAt,
        walletBalance: currentUser.walletBalance,
        loyaltyPoint: currentUser.loyaltyPoint,
        referCode: currentUser.referCode,
        referCount: currentUser.referCount,
        totalOrder: currentUser.totalOrder,
        isPhoneVerified: phoneChanged ? 0 : currentUser.isPhoneVerified,
        ...
        body: Consumer<AuthController>(builder: (context, authController, _) {
          return Consumer<ProfileController>(builder: (context, profile, _) {
            ...
            return profile.userInfoModel != null
                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            image: DecorationImage(
                              image: AssetImage(
                                Images.profileBgImage,
                              ),
                              fit: BoxFit
                                  .cover, // Can also use BoxFit.fill, BoxFit.contain, etc.
                            ),
                          ),
                        ),
                        Positioned.fill(
                          ...
                          children: [
                            ...
                            CustomTextFieldWidget(
                              ...
                              isToolTipSuffix: (isMailChanged ||
                                      (config?.customerVerification?.email ==
                                          0))
                                  ? false
                                  : true,
                            ...
                            CustomTextFieldWidget(
                              ...
                              isToolTipSuffix: (isPhoneChanged ||
                                      (config?.customerVerification?.phone ==
                                          0))
                                  ? false
                                  : true,
                              toolTipMessage: (profile
                              ...
                              suffixIcon: (isPhoneChanged ||
                                  ...
                                  : config?.customerVerification?.phone == 1 &&
                                      ...
                                      : Images.verifiedSvg,
                              suffixOnTap: () {
                                if (profile.userInfoModel?.isPhoneVerified ==
                                    0) {
                                  final configModel =
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: const BorderRadius.only(
                          topLeft: Radius.circular(
                              Dimensions.radiusSmall), // Top-left corner radius
                          topRight: Radius.circular(Dimensions
                              .radiusSmall), // Top-right corner radius
                        ),
                      ),
                ...
                : CustomLoaderWidget(height: MediaQuery.sizeOf(context).height);
          });
        }),
      ),
    );
