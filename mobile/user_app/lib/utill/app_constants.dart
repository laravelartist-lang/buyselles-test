...
class AppConstants {
  static const String appName = 'Buyselles';
  ...
  /// Firebase OAuth Web client ID — used as serverClientId for Google Sign-In on Android.
  ...
  static const String categoryGroupedProductsUri = '/api/v1/categories/products/';
  static const String categoryMixedProductsUri = '/api/v1/categories/products/';
  ...
  static const String discoveryVendorsUri = '/api/v1/discovery-vendors';
  static const String discoveryProductsUri = '/api/v1/discovery-products';
  ...
  static const String orderDigitalCodesUri =
      '/api/v1/customer/order/digital-codes/';
  static const String selectCartItemsUri = '/api/v1/cart/select-cart-items';

  // Dispute Center
  static const String disputeReasonsUri = '/api/v1/customer/disputes/reasons';
  static const String disputesUri = '/api/v1/customer/disputes';
  static const String disputeMessageUri =
      '/api/v1/customer/disputes/{id}/message';
  static const String disputeEvidenceUri =
      '/api/v1/customer/disputes/{id}/evidence';
  static const String disputeEscalateUri =
      '/api/v1/customer/disputes/{id}/escalate';
  static const String disputeConfirmClosureUri =
      '/api/v1/customer/disputes/{id}/confirm-closure';
  static const String confirmReceiptUri =
      '/api/v1/customer/disputes/order/{orderId}/confirm-receipt';
  ...
  static const String topic = 'buyselles';
  static const String demoTopic = 'demo_reset';
  static const String userAddress = 'user_address';

  // Vendor app deep link / URL scheme for opening the vendor app
  // Package: com.sixamtech.sixvalley.seller
  // The vendor app must register this scheme in its AndroidManifest.xml
  static const String vendorAppUrlScheme = 'buysellesvendor://';
