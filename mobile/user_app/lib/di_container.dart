...
import 'package:flutter_sixvalley_ecommerce/features/dispute/domain/repositories/dispute_repository.dart';
import 'package:flutter_sixvalley_ecommerce/features/dispute/domain/repositories/dispute_repository_interface.dart';
import 'package:flutter_sixvalley_ecommerce/features/dispute/domain/services/dispute_service.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => DisputeRepository(dioClient: sl()));
  sl.registerLazySingleton(() => PhysicalDiscoveryRepository(dioClient: sl()));
  ...
  sl.registerFactory(() => DigitalExportController());
  sl.registerFactory(() => ThermalPrintController());
  ...
  sl.registerFactory(() => PhysicalDiscoveryController(physicalDiscoveryRepo: sl()));
  ...
  sl.registerLazySingleton(() => disputeRepositoryInterface);
  DisputeServiceInterface disputeServiceInterface = DisputeService(disputeRepositoryInterface: sl());
  sl.registerLazySingleton(() => disputeServiceInterface);
  ...
  sl.registerLazySingleton(() => DisputeService(disputeRepositoryInterface: sl()));
}
