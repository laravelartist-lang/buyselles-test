...
class NotificationHelper {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) async {
      ...
      try{
        if(message.data.isNotEmpty) {
          ...
          } else if(notificationBody.type == 'dispute') {
            RouterHelper.getDisputeListRoute(action: RouteAction.pushReplacement);
  ...
  static Future<void> showTextNotification(String title, String body, String orderID, NotificationBody? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    const AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'buyselles', 'buyselles', playSound: true,
  ...
  static Future<void> showBigTextNotification(String? title, String body, String? orderID, NotificationBody? notificationBody, FlutterLocalNotificationsPlugin fln) async {
    ...
    AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
      'buyselles', 'buyselles', importance: Importance.max,
  ...
  static NotificationBody convertNotification(Map<String, dynamic> data){
    if(data['type'] == 'notification') {
      ...
      return NotificationBody(type: 'order', orderId: _tryParseOrderId(data['order_id']));
    }else if(data['type'] == 'wallet') {
      return NotificationBody(type: 'wallet');
    }else if(data['type'] == 'block') {
      return NotificationBody(type: 'block');
    }else if(data['type'] == 'dispute') {
      return NotificationBody(type: 'dispute', orderId: _tryParseOrderId(data['order_id']));
  ...
  static int? _tryParseOrderId(dynamic orderId) {
    if (orderId == null) {
      return null;
    }
