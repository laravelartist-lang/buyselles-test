    ...
    if (json['products'] != null) {
      ...
      json['products'].forEach((v) {
        try {
          ...
          if (kDebugMode) {
            debugPrint('ProductModel: skipped product id=${v['id']}: $e');
          }
        }
      });
    }
...
class Product {
  ...
  Product.fromJson(Map<String, dynamic> json, {bool fromGetProducts = false}) {
    final bool canParseNestedFields = json['category_ids'] == null || json['category_ids'] is! String;
    ...
    if (json['category_ids'] != null && canParseNestedFields) {
      categoryIds = [];
    ...
    currentStock = _nullableInt(json['current_stock']);
    ...
    if(json['minimum_order_qty']!=null){
      minimumOrderQty = _nullableInt(json['minimum_order_qty']);
    }
