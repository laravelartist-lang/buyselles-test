...
class AddProductController extends ChangeNotifier {
  ...
  bool _isDigitalVariationActive = false;
  bool get isDigitalVariationActive => _isDigitalVariationActive;
  ...
  void setIsDigitalVariationActive(bool isActive, {bool notify = false}) {
    _isDigitalVariationActive = isActive;
    if(notify) {
      notifyListeners();
    }
  }
