...
import 'package:sixvalley_vendor_app/features/dispute/screens/dispute_list_screen.dart';
import 'package:sixvalley_vendor_app/features/reports/screens/reports_screen.dart';
    ...
    return Consumer<SplashController>(
      builder: (context, splashController, _) {
        ...
        List<CustomBottomSheetWidget> activateMenu = [
          ...
          CustomBottomSheetWidget(image: Images.reportIcon, title: getTranslated('customers', context) ?? 'Customers',
            onTap: () => _handleMenuTap(context, const CustomerListScreen()),
          ),

          CustomBottomSheetWidget(image: Images.alertCircle, title: getTranslated('disputes', context) ?? 'Disputes',
            onTap: () => _handleMenuTap(context, const DisputeListScreen()),
          ),

          CustomBottomSheetWidget(image: Images.reportIcon, title: getTranslated('reports', context) ?? 'Reports',
            onTap: () => _handleMenuTap(context, const ReportsScreen()),
          ),
