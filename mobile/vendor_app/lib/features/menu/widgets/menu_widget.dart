      ...
      builder: (context, splashController, _) {
        return Consumer<ProfileController>(
          builder: (context, profileController, _) {
            ...
            final List<CustomBottomSheetWidget> activateMenu = [
              CustomBottomSheetWidget(
                image: '${profile?.imageFullUrl?.path}',
                isProfile: true,
              ...
              if (configModel?.posActive == 1 && profile?.posActive == 1)
                CustomBottomSheetWidget(
                  image: Images.pos,
              ...
              CustomBottomSheetWidget(
                ...
                title: getTranslated('disputes', context) ?? 'Disputes',
              ...
              if (profile?.canUseWalletTransfer ?? true)
                CustomBottomSheetWidget(
                  image: Images.wallet,
