...
class Order {
  ...
  bool? _isShippingFree;
  String? _shippingResponsibility;
  int? _editedStatus;
  ...
  Order(
    ...
    _shippingResponsibility = shippingResponsibility;
    _editedStatus = editedStatus;
    _editDueAmount = editDueAmount;
    _editReturnAmount = editReturnAmount;
    _initOrderAmount = initOrderAmount;
    _escrow = escrow;
  }
  ...
  String? get shippingResponsibility => _shippingResponsibility;
  int? get editedStatus => _editedStatus;
  Escrow? get escrow => _escrow;
  double? get editDueAmount => _editDueAmount;
  double? get editReturnAmount => _editReturnAmount;
  double? get initOrderAmount => _initOrderAmount;
  ...
  Order.fromJson(Map<String, dynamic> json) {
    ...
    _isShippingFree = json['is_shipping_free'];
    _shippingResponsibility = json['shipping_responsibility'];
    _editedStatus = json['edited_status'];
    ...
    _escrow = json['escrow'] != null ? Escrow.fromJson(json['escrow']) : null;
  }
}
...
class Escrow {
  ...
  factory Escrow.fromJson(Map<String, dynamic> json) {
    return Escrow(
      ...
      sellerAmount: json['seller_amount'] != null ? double.tryParse(json['seller_amount'].toString()) : null,
      serviceFee: json['service_fee'] != null ? double.tryParse(json['service_fee'].toString()) : null,
      status: json['status'],
      paymentMethod: json['payment_method'],
      autoReleaseAt: json['auto_release_at'],
