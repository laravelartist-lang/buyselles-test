...
import 'package:sixvalley_vendor_app/features/dispute/domain/models/dispute_reason_model.dart';
...
class DisputeModel {
  ...
  bool get canRespond => status == 'open' || status == 'vendor_response';
  bool get canUploadEvidence => canRespond;
  ...
  factory DisputeModel.fromJson(Map<String, dynamic> json) {
    return DisputeModel(
      ...
      resolvedBy: json['resolved_by'] == null ? null : int.tryParse('${json['resolved_by']}'),
