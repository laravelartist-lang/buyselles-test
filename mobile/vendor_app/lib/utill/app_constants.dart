...
class AppConstants {
  ...
  // ─── Digital Code Import ────────────────────────────────────────────────────
  static const String digitalCodeBulkTemplate = '/api/v3/seller/products/digital-codes/template';
  static const String digitalCodeBulkUpload = '/api/v3/seller/products/digital-codes/upload';
  static const String digitalCodeList = '/api/v3/seller/products'; // append /{productId}/digital-codes
  static const String digitalCodeProductTemplate = '/api/v3/seller/products'; // append /{productId}/digital-codes/template
  static const String digitalCodeProductImport = '/api/v3/seller/products'; // append /{productId}/digital-codes/import
  static const String digitalCodeManualAdd = '/api/v3/seller/products'; // append /{productId}/digital-codes/manual
  static const String digitalCodeToggleStatus = '/api/v3/seller/products/digital-codes'; // append /{id}/toggle-status
  static const String digitalCodeDecrypt = '/api/v3/seller/products/digital-codes'; // append /{id}/decrypt
  static const String digitalCodeDelete = '/api/v3/seller/products/digital-codes'; // append /{id}
  ...
  static const String editOrderSubmit = '/api/v3/seller/orders/edit-order-submit';

  static const String editOrderValidation = '/api/v3/seller/orders/edit-order-validation';
  ...
  // ─── Disputes ────────────────────────────────────────────────────────────
  static const String disputeListUri = '/api/v3/seller/disputes';
  static const String disputeDetailUri = '/api/v3/seller/disputes/'; // append {id}
  static const String disputeMessageUri = '/api/v3/seller/disputes/'; // append {id}/message
  static const String disputeEvidenceUri = '/api/v3/seller/disputes/'; // append {id}/evidence
  static const String disputeEscalateUri = '/api/v3/seller/disputes/'; // append {id}/escalate

  static const String getCountriesUri = '/api/v1/get-countries';
  static const String getCitiesUri = '/api/v1/get-cities/';
  static const String getAreasUri = '/api/v1/get-areas/';
