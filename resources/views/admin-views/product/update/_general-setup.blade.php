            ...
            <div class="card-body">
                <div class="bg-section rounded-10 p-12 p-sm-20">
                    <div class="row gy-4">
                            ...
                            <div class="form-group">
                                <label class="form-check form--check">
                                    <input type="checkbox" class="form-check-input" name="is_direct_topup" id="is-direct-topup-input"
                                        value="1" {{ old('is_direct_topup', $product->is_direct_topup) ? 'checked' : '' }}>
                        ...
                        <div class="col-md-12 show-for-digital-product" id="direct-topup-config" style="{{ old('is_direct_topup', $product->is_direct_topup) ? '' : 'display: none;' }}">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6 col-lg-4">
                                            ...
                                            <input type="text" name="direct_topup_account_label" class="form-control"
                                                value="{{ old('direct_topup_account_label', $product->direct_topup_account_label) }}"
                                        ...
                                        <div class="col-md-6 col-lg-4">
                                            ...
                                            <input type="number" step="0.0001" min="0" name="direct_topup_min_quantity" class="form-control"
                                                value="{{ old('direct_topup_min_quantity', $product->direct_topup_min_quantity) }}">
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            ...
                                            <input type="number" step="0.0001" min="0" name="direct_topup_max_quantity" class="form-control"
                                                value="{{ old('direct_topup_max_quantity', $product->direct_topup_max_quantity) }}">
                                        </div>
                                        <div class="col-md-6 col-lg-4">
                                            ...
                                            <input type="number" step="0.00000001" min="0" name="direct_topup_price_per_unit" class="form-control"
                                                value="{{ old('direct_topup_price_per_unit', $product->direct_topup_price_per_unit) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
