                        ...
                        <div class="media-body">
                            ...
                            <div class="d-flex gap-3 justify-content-between align-items-end">
                                <div class="d-flex flex-column gap-1 {{ $product && $product->status == 0?'blur-section':'' }}">
                                    <div class="fs-12">
                                        <span class="cart_quantity_{{ $cartItem['id'] }}">{{ $displayQuantity }}</span>
                                    ...
                                    <div class="product__price d-flex flex-wrap gap-2">
                                        @if($cartItem['discount'] >0)
                                            <del class="product__old-price quantity_price_of_{{ $cartItem['id'] }}">{{ webCurrencyConverter($cartItem['price'] * ($isDirectTopUpItem ? 1 : $cartItem['quantity'])) }}</del>
                                        @endif
                                        <ins class="product__new-price discount_price_of_{{ $cartItem['id'] }}">{{ webCurrencyConverter($lineTotal) }}</ins>
                                    </div>
                                </div>
