...
<ul class="list-unstyled d-flex justify-content-around gap-3 mb-0 position-relative bg-white shadow-lg">
    ...
    <li>
        <div class="dropup position-static">
            ...
            <ul class="dropdown-menu scrollY-60 bs-dropdown-min-width--100 shadow-sm cart-dropdown-mobile-view"
                id="cart_dropdown">
                                    ...
                                    <div class="d-flex gap-3 justify-content-between align-items-end">
                                        <div
                                            ...
                                            <div class="fs-12"><span
                                                    class="cart_quantity_{{ $cartItem['id'] }}">{{ $displayQuantity }}</span>
                                            ...
                                            <div class="product__price d-flex flex-wrap gap-2">
                                                ...
                                                <del
                                                    class="product__old-price quantity_price_of_{{ $cartItem['id'] }}">{{webCurrencyConverter($cartItem['price'] * ($isDirectTopUpItem ? 1 : $cartItem['quantity']))}}</del>
                                                @endif
                                                <ins
                                                    class="product__new-price discount_price_of_{{ $cartItem['id'] }}">{{webCurrencyConverter($lineTotal)}}</ins>
                                            </div>
                                        </div>
                    ...
                    <div class="widget-cart-item">
                        <div class="p-2 pt-0">
                            <div class="d-flex justify-content-end w-100">
                                <button type="button" class="btn-link text-dark opacity-25 fs-18 close-cart-btn">
                                    <i class="bi bi-x-circle-fill"></i>
                                </button>
                            </div>
                            <div class="d-flex flex-column align-items-center text-center">
                                <img width="60" class="svg mb-3" src="{{ theme_asset('assets/img/empty-state/empty-cart-new.svg') }}" alt="">
                                <h5 class="text-center mb-2">
                                    {{ translate('your_cart_is_empty!') }}
                                </h5>
                                <p class="fs-12 mb-30">{{ translate('explore_thousands_of_quality_products,_exclusive_deals,_and_fast_delivery_options_tailored_just_for_you.') }}</p>
                                <button type="button" class="btn btn-primary fw-semibold text-capitalize mb-2 close-cart-btn">{{ translate('ok,_got_it') }}</button>
                            </div>
                        </div>
                    </div>
                @endif
...
<div class="cart-overlay" id="cart_overlay"></div>
